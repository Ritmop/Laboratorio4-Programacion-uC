...
;
;Programa: Contador de segundos con 2 display de 7 segmentos
;Hardware: 4 leds PortA<0:3>
;	   Display 7 segmentos PortC<0:6>
;	   Display 7 segmentos PortD<0:6>
;	   2 botones PortB<4> y PortB<7>
;
;Creado: 13/02/23
;Última modificación: 17/02/23
;
;-------------------------------------------------------------------------------
    PROCESSOR 16F887
    #include <xc.inc>
